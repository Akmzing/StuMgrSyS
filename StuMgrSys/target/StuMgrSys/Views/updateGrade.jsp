...
<div class="main-body">
    ...
    <form:form action="/updateGradePost" method="post" commandName="scP" role="form">
        ...
        <div class="form-group">
            <label>课程名:</label>
            <label>${sc.cname}</label>
        </div>
        <div class="form-group">
            <label>学分:</label>
            <label>${sc.ccredit}</label>
        </div>
        <div class="form-group">
            <label for="grade">成绩:</label>
            <input type="text" class="form-control" id="grade" name="grade" placeholder="输入成绩:"
                   value="${sc.grade}"/>
            <p style="color:red">${errGrade}</p>
        </div>
        <input type="hidden" id="sno" name="sno" value="${sc.sno}"/>
        <input type="hidden" id="cno" name="cno" value="${sc.cno}"/>
        <input type="hidden" id="cname" name="cname" value="${sc.cname}"/>
        <input type="hidden" id="ccredit" name="ccredit" value="${sc.ccredit}"/>
