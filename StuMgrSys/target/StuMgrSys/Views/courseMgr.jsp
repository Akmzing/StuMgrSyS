            ...
            <table class="table table-bordered table-striped">
                ...
                <c:forEach items="${courseList}" var="course">
                    <tr>
                        ...
                        <td>
                            <a href="/showCourse/${course.cno}" type="button" class="btn btn-sm btn-success">详情</a>
                            <a href="/updateCourse/${course.cno}" type="button" class="btn btn-sm btn-warning">修改</a>
                            <a href="/delCourse/${course.cno}" type="button" class="btn btn-sm btn-danger">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
