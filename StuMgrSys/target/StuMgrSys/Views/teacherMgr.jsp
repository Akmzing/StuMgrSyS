            ...
            <table class="table table-bordered table-striped">
                ...
                <c:forEach items="${userList}" var="user">
                    <tr>
                        ...
                        <td>${user.tsalary}</td>
                        <td>
                            <a href="/showTeacher/${user.tno}" type="button" class="btn btn-sm btn-success">详情</a>
                            <a href="/updateTeacher/${user.tno}" type="button" class="btn btn-sm btn-warning">修改</a>
                            <a href="/delTeacher/${user.tno}" type="button" class="btn btn-sm btn-danger">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
