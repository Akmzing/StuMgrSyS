...
<div class="main-body">
    ...
    <form:form action="/updateTeacherPost" method="post" commandName="userP" role="form">
        <div class="form-group">
            <label>工号:</label>
            <label>${user.tno}</label>
        </div>
        <div class="form-group">
            <label for="tname">姓名:</label>
            <input type="text" class="form-control" id="tname" name="tname" placeholder="输入姓名:"
                   value="${user.tname}"/>
            <p style="color:red">${errTname}</p>
        </div>
        <div class="form-group">
            <label for="tdept">职称:</label>
            <input type="text" class="form-control" id="tdept" name="tdept" placeholder="输入职称:"
                   value="${user.tdept}"/>
            <p style="color:red">${errTdept}</p>
        </div>
        <div class="form-group">
            <label for="tsalary">工资:</label>
            <input type="text" class="form-control" id="tsalary" name="tsalary" placeholder="输入工资:"
                   value="${user.tsalary}"/>
            <p style="color:red">${errTsalary}</p>
        </div>
        <div class="form-group">
            <label for="tpassword">密码:</label>
            <input type="text" class="form-control" id="tpassword" name="tpassword" placeholder="输入密码:"
                   value="${user.tpassword}"/>
            <p style="color:red">${errTpassword}</p>
        </div>

        <input type="hidden" id="tno" name="tno" value="${user.tno}"/>
