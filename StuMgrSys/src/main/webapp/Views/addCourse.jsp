...
<div class="main-body">
    ...
    <h1>添加课程</h1>
    <hr/>
    <form:form action="/addCoursePost" method="post" role="form" commandName="courseP">
        <div class="form-group">
            <label for="cno">课程号:</label>
            <input type="text" class="form-control" id="cno" name="cno" placeholder="输入课程号:" value="${course.cno}"/>
            <p style="color:red">${errCno}</p>
        </div>
        <div class="form-group">
            <label for="cname">课程名:</label>
            <input type="text" class="form-control" id="cname" name="cname" placeholder="输入课程名:" value="${course.cname}"/>
            <p style="color:red">${errCname}</p>
        </div>
        <div class="form-group">
            <label for="ccredit">学分:</label>
            <input type="text" class="form-control" id="ccredit" name="ccredit" placeholder="输入学分:" value="${course.ccredit}"/>
